...
import 'hortalicas_model.dart';
export 'hortalicas_model.dart';

class HortalicasWidget extends StatefulWidget {
  const HortalicasWidget({super.key});

  @override
  State<HortalicasWidget> createState() => _HortalicasWidgetState();
}

class _HortalicasWidgetState extends State<HortalicasWidget>
    with TickerProviderStateMixin {
  late HortalicasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HortalicasModel());
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ljj6a8b3' /* Conheça as hortaliças */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'c28uxc20' /* Clique para saber mais sobre a... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
