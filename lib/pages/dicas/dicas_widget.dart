                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: CarouselSlider(
                              items: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://www.wikihow.com/images/thumb/0/0b/Water-Succulents-Step-6.jpg/v4-728px-Water-Succulents-Step-6.jpg.webp',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.network(
                                    'https://www.wikihow.com/images/thumb/3/31/Water-Succulents-Step-8.jpg/v4-728px-Water-Succulents-Step-8.jpg.webp',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.network(
                                    'https://www.wikihow.com/images/thumb/e/ea/Water-Succulents-Step-4.jpg/v4-728px-Water-Succulents-Step-4.jpg.webp',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'qfzl9ezn' /*  • Lembre-se que as ferramenta... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
