                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            0.0, 0.0, 128.0, 0.0),
                        child: Image.asset(
                          'assets/images/Apresentacao1.png',
                          width: 300.0,
                          height: 500.0,
                          fit: BoxFit.contain,
                        ).animateOnPageLoad(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'nimsi6l9' /* O Horta App é seu novo ajudant... */,
                              ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lwvgq39u' /* Ele te aproximará dos conceito... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            0.0, 96.0, 0.0, 96.0),
                        child: Image.asset(
                          'assets/images/Apresentacao2.png',
                          width: 380.0,
                          height: 280.0,
                          fit: BoxFit.cover,
                        ).animateOnPageLoad(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '182i43lm' /* Chega de dúvidas, consulte seu... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '4rzh81w4' /* Descubra rapidamente: novas es... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            0.0, 96.0, 0.0, 96.0),
                        child: Image.asset(
                          'assets/images/Apresentacao3.png',
                          width: 380.0,
                          height: 308.0,
                          fit: BoxFit.cover,
                        ).animateOnPageLoad(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '4z6cx6s0' /* Gerencie de onde estiver */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lj6l34fe' /* Nada de desculpas! Com o Horta... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '5chjktrm' /* Aproveite o Horta App! */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .headlineMedium
                                    .override(
                                      fontFamily: 'Outfit',
                                      color: const Color(0xFF003600),
                                      letterSpacing: 0.0,
                                    ),
                              ).animateOnPageLoad(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ylk92frl' /* Faça o login ou cadastre-se pa... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                ...
                child: Padding(
                  ...
                  child: smooth_page_indicator.SmoothPageIndicator(
                    ...
                    effect: smooth_page_indicator.ExpandingDotsEffect(
                      ...
                      activeDotColor: const Color(0xFF03CB00),
